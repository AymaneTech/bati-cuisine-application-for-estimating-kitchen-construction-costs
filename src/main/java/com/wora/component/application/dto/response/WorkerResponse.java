...
public class WorkerResponse extends ComponentResponse {
    ...
    public WorkerResponse(ComponentId id, String name, String tva, String projectId, Double hourlyRate, Double workingHours, Double productivity, LocalDateTime createdAt, LocalDateTime updatedAt) {
        super(id, name, tva, ComponentType.WORKER, projectId, createdAt, updatedAt);
